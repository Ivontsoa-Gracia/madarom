...
document.addEventListener('DOMContentLoaded', () => {
  fetch('header.html')
    ...
    .then(html => {
      ...
      const cartBtnDesktop = document.querySelector('.btn-cart'); // bouton panier desktop
      const cartBtnMobile = document.getElementById('cart-count-mobile')?.closest('.btn-cart'); // bouton panier mobile
      const loginBtn = document.getElementById('login-btn'); // bouton login desktop
      const loginBtnMobile = document.getElementById('login-btn-mobile'); // bouton login mobile si tu en as
